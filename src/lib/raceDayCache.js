...
export function markRaceScanned(raceKey, at = Date.now(), priceHash = '') { const race = store.racesByRaceKey.get(raceKey); if (race) { race.lastScannedAt = at; race.lastScannedPriceHash = priceHash; } }
