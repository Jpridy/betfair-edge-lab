...
export function cycleToRow(cycle) {
  ...
  return {
    ...
    selectedRaceKey:summary.selectedRaceKey || '', selectedRaceName:summary.selectedRaceName || '', selectedRaceStartTime:summary.selectedRaceStartTime || '', secondsToStart:summary.secondsToStart ?? '',
