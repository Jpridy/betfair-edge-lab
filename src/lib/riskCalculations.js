...
export function calculateRiskMetrics(paperOrders, settings = {}) {
  ...
  // Canonical exposure is calculated once in riskExposure and reused everywhere.
  const backExposure=reconciledExposure.totalBackExposure;
  const layLiability=reconciledExposure.totalLayLiability;
  const paperExposure=reconciledExposure.totalExposure;
  ...
  return {
    ...
    riskExposureReconciliationPassed:reconciledExposure.riskExposureReconciliationPassed,
