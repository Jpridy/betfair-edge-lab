export const PAPER_VALIDATION_PRESET = Object.freeze({
  appSettings: Object.freeze({
    ...
    maxOpenOrders: 5,
    maxUnmatchedOrders: 2,
    maxTradesPerMarket: 1,
    maxTradesPerRunner: 1,
    maxTradesPerDay: 20,
    minimumLiquidity: 50,
    minimumTradedVolume: 5000,
    minOdds: 1.5,
    maxOdds: 15,
    ...
    minimumPaperTrades: 500,
    defaultPersistenceType: 'LAPSE',
    mode: 'connected_paper',
    dailyResetAt: null,
    paperProofMode: false,
  }),
  botSettings: Object.freeze({
    botEnabled: true,
    botMode: 'paper',
    ...
    maxDrawdownLimit: 300,
    maxLosingStreak: 8,
    paperProofMode: false,
  }),
  featherlessSettings: Object.freeze({
    enabled: true,
    ...
    placeMinOdds: 1.2,
    placeMaxOdds: 10,
    placeMinLiquidity: 50,
    placeMaxSpreadTicks: 4,
    placeMinEdge: 4,
    placeMinROI: 3,
    ...
    maxExternalProbabilityAdjustment: 0.02,
    minExternalSourceCount: 2,
    minExternalDataQuality: 60,
    requireExternalSearchForLiveBetting: true,
    externalSearchCacheTtlMinutes: 30,
    ...
    includeOpenAIResearchInRacePack: false,
    includeRiskContextInRacePack: true,
    allowMarketOnlyFallbackInDebug: true,
    allowMarketOnlyFallbackInPaperProof: false,
    allowMarketOnlyFallbackInNormalMode: false,
    allowDeterministicFallback: false,
    featherlessTimeoutMs: 60000,
    featherlessStrictJson: true,
    paperProofExternalSearchEnabled: false,
    favouriteContextEnabled: true,
    favouriteContextMaxProbabilityAdjustment: 0.01,
    favouriteStrongConfidenceBoost: 3,
    favouriteWeakConfidencePenalty: 5,
    requireFavouriteContextForWinMarket: false,
    allowFavouriteLayOnlyWhenVulnerable: true,
    racePackCacheTtlMinutes: 10,
    aiResultCacheTtlSeconds: 60,
    rerunAiOnMajorPriceMove: true,
    majorPriceMoveTicks: 3,
    prewarmOpenAIWithinMinutes: 0,
    completedRaceRetentionHours: 6,
    selfCalibrationEnabled: false,
    calibrationObjectiveMode: 'STRIKE_RATE_WITH_PROFIT',
    calibrationNightlyEnabled: false,
    autoApplyChampion: false,
    paperProofMode: false,
  }),
  validationRules: Object.freeze({
    minimumSettledBetsOverall: 500,
    minimumSettledBetsPerSegment: 100,
    requiredOutOfSampleROI: 0.02,
    requiredBootstrapLower95PctROI: 0,
